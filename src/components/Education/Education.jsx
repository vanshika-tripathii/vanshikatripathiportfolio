    ...
    >
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="absolute left-1 sm:left-1/2 transform -translate-x-1/2 top-1/2 sm:top-1/2 -translate-y-1/2 bg-white border-4 border-[#8245ec] w-14 h-14 sm:w-15 sm:h-15 rounded-full flex justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
