      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => {
          ...
          return (
            ...
            >
              {/* Circle */}
              <div className="absolute left-1/2 top-0 md:top-1/2 transform -translate-x-1/2 md:-translate-y-1/2 bg-white border-4 border-[#8245ec] w-12 h-12 sm:w-14 sm:h-14 rounded-full flex justify-center items-center z-10">
                <img
                  src={experience.img}
              ...
              <div
                className={`w-full sm:max-w-md p-6 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] transform transition-transform duration-300 hover:scale-105
                  md:${isLeft ? "mr-[calc(50%+0rem)]" : "ml-[calc(50%+0rem)]"}`}
              >
