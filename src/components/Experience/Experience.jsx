...
const Experience = () => {
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Vertical Line (always visible, both desktop + mobile) */}
        <div className="absolute top-0 right-5 h-full w-[2px] bg-purple-400"></div>

        <div className="flex flex-col gap-12">
          {experiences.map((exp, index) => (
            <div key={index} className="relative pr-12">
              {/* Timeline Circle (always visible) */}
              <div className="absolute top-6 right-[2px] w-5 h-5 rounded-full bg-purple-500 border-4 border-white"></div>

              {/* Card */}
              <div className="p-6 rounded-2xl bg-[#1e1e2f] shadow-lg text-white">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{exp.school}</p>
